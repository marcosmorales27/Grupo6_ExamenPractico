...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-02-2026 a las 19:14:44
...
(2, 'marcos', 'morales', 'marcos@gmail.com');
...
INSERT INTO `notas` (`id`, `alumno_id`, `valor`) VALUES
(1, 2, 3.00),
(2, 2, 5.00),
(3, 2, 8.00);
...
--
ALTER TABLE `nota`
  ADD CONSTRAINT `nota_ibfk_1` FOREIGN KEY (`alumno_id`) REFERENCES `alumno` (`id`) ON DELETE CASCADE;
